...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Remove version numbers from requirements.txt')
    parser.add_argument('input_file', type=str, help='Path to the input requirements.txt file')
